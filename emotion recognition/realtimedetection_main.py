...
webcam=cv2.VideoCapture(r"D:\Study Stuff\Sem 5\Mini Project\spaCy\emotion recognition\vd_test.mp4")
labels = {0 : 'angry', 1 : 'disgust', 2 : 'fear', 3 : 'happy', 4 : 'neutral', 5 : 'sad', 6 : 'surprise'}
text = []
label_pred = {0 : [], 1 : [], 2 : [], 3 : [], 4 : [], 5 : [], 6 : []}
...
while True:
    ...
    try: 
        ...
        print(f"person currently {(text)}")
        print(f"person currently {max(text)}")